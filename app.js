...
const STAFF0 = [
  ...
  { id: "s8", first: "Training", last: "Staff", name: "Staff, Training", role: "Staff", pin: "0000", password: "training123", phone: "", email: "training@teamisr.net", on: true, homes: ["SCH"] },
...
function IndividualSupportRecord() {
  ...
  const [docs, setDocs] = useState([
    { id: "dd1", resId: "r3", type: "Shift", d: "2026-03-12", t: "7:15 AM", user: "Training Staff", by: "s8", text: "Jane had a calm morning. Woke at 6:30 AM, completed morning hygiene with minimal verbal prompts. Took all AM medications without issue. Ate breakfast (oatmeal with fruit). Participated in art activity from 9-10 AM \u2014 painted a landscape. No anxiety episodes during shift.", shiftData: { communityOffered: "yes", choicesOffered: "yes", illness: "no", sir: "no", medAppt: "no", outing: "no" } },
    { id: "dd2", resId: "r3", type: "Shift", d: "2026-03-11", t: "3:30 PM", user: "Training Staff", by: "s8", text: "Jane had a mild anxiety episode at 2:15 PM when fire alarm test occurred. Deep breathing techniques were used \u2014 resolved in 8 minutes. Jane chose to listen to music in her room for 20 minutes after. Ate lunch and dinner well. PM medications given on time.", shiftData: { communityOffered: "yes", choicesOffered: "yes", illness: "no", sir: "no", medAppt: "no", outing: "no" } },
    { id: "dd3", resId: "r4", type: "Shift", d: "2026-03-12", t: "7:30 AM", user: "Training Staff", by: "s8", text: "Marcus followed his visual schedule well this morning. Completed hand washing independently (9/10 steps). Required full physical prompt for teeth brushing. AM medications given with breakfast. No seizure activity. Elopement prevention: gate alarm tested and functional. Marcus enjoyed puzzle time from 8:30-9:30 AM.", shiftData: { communityOffered: "yes", choicesOffered: "yes", illness: "no", sir: "no", medAppt: "no", outing: "no" } },
