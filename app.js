        ...
        /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "flex-start" } },
          ...
          /* @__PURE__ */ React.createElement("div", { style: { flex: 1, minWidth: 0 } },
            /* @__PURE__ */ React.createElement("div", { style: { display: "grid", gridTemplateColumns: "1fr 1fr", gap: "3px 10px", fontSize: 11 } },
              /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: C.tx3, fontSize: 10 } }, "INSTRUCTIONS"), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, color: C.tx } }, "Take " + (m.tabsPerDose || 1) + " " + (m.tabsPerDose > 1 ? "tabs" : "tab") + " " + (m.route || "by mouth").toLowerCase() + " " + (m.freq || "daily").toLowerCase()), /* @__PURE__ */ React.createElement("div", { style: { marginTop: 4, padding: "5px 8px", background: "#5856d608", borderRadius: 7, border: "1px solid #5856d620" } }, (() => {
              ...
              m.rx && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("span", { style: { color: C.tx3, fontSize: 10 } }, "RX #"), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, color: C.tx } }, m.rx)),
              m.doctor && /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement("span", { style: { color: C.tx3, fontSize: 10 } }, "PRESCRIBING DR"), /* @__PURE__ */ React.createElement("div", { style: { fontWeight: 600, color: C.tx } }, m.doctor)),
              m.reason && /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement("span", { style: { color: C.tx3, fontSize: 10 } }, "REASON FOR USE"), /* @__PURE__ */ React.createElement("div", { style: { color: C.tx2 } }, m.reason)),
              m.instr && /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement("span", { style: { color: C.tx3, fontSize: 10 } }, "SPECIAL INSTRUCTIONS"), /* @__PURE__ */ React.createElement("div", { style: { color: C.org, fontWeight: 600 } }, m.instr)),
              m.sides && m.sides.length > 0 && /* @__PURE__ */ React.createElement("div", { style: { gridColumn: "1 / -1" } }, /* @__PURE__ */ React.createElement("span", { style: { color: C.tx3, fontSize: 10 } }, "SIDE EFFECTS"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 3, marginTop: 2 } }, m.sides.slice(0,4).map((s, si) => /* @__PURE__ */ React.createElement("span", { key: si, style: { fontSize: 9, padding: "1px 5px", borderRadius: 4, background: C.org + "10", color: C.org, fontWeight: 600 } }, s))))
            )
          )
        )
      ));
