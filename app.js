...
function IndividualSupportRecord() {
  ...
  const [newMed, setNewMed] = useState({ name: "", dose: "", route: "By Mouth", freq: "Daily", times: "08:00", instr: "", doctor: "", rx: "", pillColor: "", pillDesc: "", reason: "", tabsPerDose: 1, startDate: "", pillCount: "", expiryDate: "", specialParam: false, specialParamInstr: "", specialParamTimes: "", isShortTerm: false, shortTermStart: "", shortTermEnd: "", shortTermStartTime: "08:00", shortTermEndTime: "08:00" });
...
"severity":"low/medium/high/critical"}` }] }) });
  ...
  const [specialParamForm, setSpecialParamForm] = useState(null); // { med, sTime, type, response: "" }
  ...
  const renderModal = () => {
    ...
    if (modal === "addMed") {
      ...
      isAM && /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px", marginBottom: 10 } },
        ...
        newMed.specialParam && /* @__PURE__ */ React.createElement("div", { style: { padding: "10px 12px", background: C.red + "05", borderRadius: 10, border: "1.5px solid " + C.red + "25" } },
          ...
          /* @__PURE__ */ React.createElement("div", { style: { fontSize: 9, color: C.tx3, fontWeight: 600, marginBottom: 3 } }, "REQUIRED BEFORE DOSE TIME(S) (e.g. 08:00, 20:00 or 'All times')"),
          /* @__PURE__ */ React.createElement("input", { type: "text", value: newMed.specialParamTimes, onChange: (e) => setNewMed((p) => ({ ...p, specialParamTimes: e.target.value })), placeholder: "e.g. 08:00, 20:00 or All times", style: { width: "100%", padding: "8px 10px", borderRadius: 8, border: "1.5px solid " + C.red + "30", fontSize: 12, fontFamily: C.font, boxSizing: "border-box" } }))),
      isAM && /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px", marginBottom: 10 } },
      ...
      /* @__PURE__ */ React.createElement("div", { style: { padding: "8px 14px" } }, /* @__PURE__ */ React.createElement(Btn, { full: true, onClick: () => {
        ...
        const nm = { id: "m" + Date.now(), resId: selRes || "r1", name: newMed.name, dose: newMed.dose, route: newMed.route, freq: newMed.freq, times: newMed.times.split(",").map((x) => x.trim()).filter(Boolean), instr: newMed.instr, doctor: newMed.doctor, rx: newMed.rx, reason: newMed.reason, status: newMed.isShortTerm ? "shortterm" : "active", ...ai, pill: { ...customPill, img: newMed.pillImg || "" }, pillColor: newMed.pillColor, pillDesc: newMed.pillDesc, tabsPerDose: newMed.tabsPerDose || 1, startDate: newMed.startDate || "", pillCount: newMed.pillCount ? parseInt(newMed.pillCount) : 0, expiryDate: newMed.expiryDate || "", specialParam: newMed.specialParam || false, specialParamInstr: newMed.specialParamInstr || "", specialParamTimes: newMed.specialParamTimes || "", nextCyclePillCount: 0, nextCycleStartDate: "", isShortTerm: newMed.isShortTerm || false, shortTermStart: newMed.shortTermStart || "", shortTermEnd: newMed.shortTermEnd || "", shortTermStartTime: newMed.shortTermStartTime || "08:00", shortTermEndTime: newMed.shortTermEndTime || "08:00" };
        setMeds((p) => [...p, nm]);
        setNewMed({ name: "", dose: "", route: "By Mouth", freq: "Daily", times: "08:00", instr: "", doctor: "", rx: "", pillColor: "", pillDesc: "", reason: "", tabsPerDose: 1, startDate: "", pillCount: "", expiryDate: "", specialParam: false, specialParamInstr: "", specialParamTimes: "", isShortTerm: false, shortTermStart: "", shortTermEnd: "", shortTermStartTime: "08:00", shortTermEndTime: "08:00" });
        setAiPrev(null);
        setModal(null);
    ...
    if (modal === "specialParam" && specialParamForm && specialParamForm.med) {
      ...
      const isValid = (specialParamForm.response || "").trim().length >= 3;
      return /* @__PURE__ */ React.createElement(Modal, { title: "⚠️ Special Parameter Required", onClose: () => { setSpecialParamForm(null); setModal(null); } }, /* @__PURE__ */ React.createElement("div", { style: { paddingBottom: 14 } },
        ...
        /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px", marginBottom: 12 } },
          /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: C.tx3, textTransform: "uppercase", letterSpacing: 0.5, marginBottom: 6 } }, "Your Response / Result *"),
          /* @__PURE__ */ React.createElement("textarea", { value: specialParamForm.response, onChange: (e) => setSpecialParamForm((p) => ({ ...p, response: e.target.value })), placeholder: "Enter the result or confirmation of the completed task (e.g. BP: 118/76, blood sugar: 105 mg/dL)...", rows: 4, style: { width: "100%", padding: "10px 12px", borderRadius: 10, border: "1.5px solid " + (isValid ? C.grn : C.red + "40"), fontSize: 13, fontFamily: C.font, boxSizing: "border-box", resize: "none" } }),
          !isValid && /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: C.red, marginTop: 4 } }, "You must enter a response to proceed")),
        /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px", display: "flex", gap: 10 } },
          ...
          /* @__PURE__ */ React.createElement(Btn, { full: true, color: C.red, disabled: !isValid, onClick: () => {
            const { med, sTime, type, response } = specialParamForm;
            // Log the special param response in docs
            setDocs((p) => [...p, { id: "d" + Date.now(), resId: med.resId, type: "Special Parameter", d: today, t: nowTime, user: user.name, by: user.id, text: "⚠️ Special Param — " + med.name + ": " + response + " — " + (residents.find((x) => x.id === med.resId) ? fullName(residents.find((x) => x.id === med.resId).name) : "?") }]);
            setSpecialParamForm(null);
            // Now proceed with actual administration
            if (type === "prn") {
          ...
          } }, "✓ Confirmed — Proceed to Administer"))));
    }
