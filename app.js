...
function IndividualSupportRecord() {
  ...
  const [newMed, setNewMed] = useState({ name: "", dose: "", route: "By Mouth", freq: "Daily", times: "08:00", instr: "", doctor: "", rx: "", pillColor: "", pillDesc: "", reason: "", tabsPerDose: 1, startDate: "", pillCount: "", isShortTerm: false, shortTermStart: "", shortTermEnd: "", shortTermStartTime: "08:00", shortTermEndTime: "08:00" });
      ...
      return /* @__PURE__ */ React.createElement("div", { key: m.id, style: { padding: "10px 12px", borderBottom: i < arr.length - 1 ? "0.5px solid " + C.sepL : "none", background: tc ? tc.bgL : "transparent" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, cm ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 3 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 4, padding: "3px 8px", borderRadius: 6, background: C.grn + "12", border: "1.5px solid " + C.grn + "40" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 10, height: 10, borderRadius: 5, background: C.grn } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, fontWeight: 700, color: C.grn } }, "Active")), /* @__PURE__ */ React.createElement("div", { onClick: () => {
        ...
        setModal("medD");
          ...
          /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 12, flexWrap: "wrap", flex: 1 } },
            ...
            isAM && /* @__PURE__ */ React.createElement("div", null,
            ...
            pillsLeft <= 7 && /* @__PURE__ */ React.createElement("div", { style: { padding: "4px 10px", background: C.red, borderRadius: 8, alignSelf: "center" } },
              /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontWeight: 700, color: "#fff" } }, "⚠️ Low — reorder now")))); })(), isAM && /* @__PURE__ */ React.createElement("button", { onClick: (e) => { e.stopPropagation(); setMedUpdateForm({ ...m, origDose: m.dose, origFreq: m.freq, origTimes: (m.times || []).join(", "), origTabsPerDose: m.tabsPerDose || 1 }); setMedUpdateTab("info"); setModal("medUpdate"); }, style: { display: "flex", alignItems: "center", gap: 4, padding: "4px 10px", borderRadius: 7, border: "1.5px solid " + C.blue + "50", background: C.blue + "10", color: C.blue, fontSize: 10, fontWeight: 700, cursor: "pointer", fontFamily: C.font, marginTop: 4 } }, "✏️ Edit"),
    ...
    if (modal === "medUpdate" && medUpdateForm) {
      ...
      return /* @__PURE__ */ React.createElement(Modal, { title: "Update: " + muf.name, onClose: () => { setMedUpdateForm(null); setModal(null); }, wide: true }, /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px" } },
        ...
        medUpdateTab === "pills" && /* @__PURE__ */ React.createElement(React.Fragment, null,
          ...
          /* @__PURE__ */ React.createElement("div", { style: { padding: "8px 0" } }, /* @__PURE__ */ React.createElement(Btn, { full: true, color: C.grn, onClick: () => { setMeds((p) => p.map((x) => x.id === muf.id ? { ...x, startDate: muf.startDate, pillCount: muf.pillCount, nextCyclePillCount: muf.nextCyclePillCount, nextCycleStartDate: muf.nextCycleStartDate } : x)); setMedUpdateForm(null); setModal(null); } }, "✓ Save Pill Count")))));
    }
    if (modal === "bowel") {
