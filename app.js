...
"severity":"low/medium/high/critical"}` }] }) });
  ...
  const ResDetail = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Hdr, { title: fn, left: /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      vitalsTab === "bowel" && /* @__PURE__ */ React.createElement("div", null,
        /* @__PURE__ */ React.createElement(Card, { style: { marginTop: 8, marginBottom: 8, overflow: "hidden" } },
          ...
          /* @__PURE__ */ React.createElement("div", { style: { padding: 12 } },
            /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontWeight: 700, color: C.tx3, marginBottom: 6 } }, "TYPE (Bristol Scale)"),
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 5, marginBottom: 8 } },
              [{ id: 1, label: "Type 1 — Hard lumps" }, { id: 2, label: "Type 2 — Lumpy" }, { id: 3, label: "Type 3 — Cracked" }, { id: 4, label: "Type 4 — Smooth" }, { id: 5, label: "Type 5 — Soft blobs" }, { id: 6, label: "Type 6 — Fluffy" }, { id: 7, label: "Type 7 — Liquid" }].map((bt) => /* @__PURE__ */ React.createElement("button", { key: bt.id, onClick: () => {
                const sel = document.getElementById("bowel-size")?.value || "Medium";
                setDocs((p) => [...p, { id: "d" + Date.now(), resId: selRes, type: "Vitals", d: today, t: new Date().toLocaleTimeString([], { hour: "numeric", minute: "2-digit" }), user: user.name, by: user.id, text: "🚽 Bowel — " + bt.label + " | Size: " + sel + " — " + fn }]);
              }, style: { padding: "6px 10px", borderRadius: 8, border: "1.5px solid " + C.org + "40", background: C.org + "08", color: C.org, fontSize: 12, fontWeight: 600, cursor: "pointer", fontFamily: C.font } }, bt.label))),
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 8, alignItems: "center" } },
              /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, fontWeight: 700, color: C.tx3 } }, "SIZE:"),
              /* @__PURE__ */ React.createElement("select", { id: "bowel-size", style: { padding: "6px 8px", borderRadius: 8, border: "1px solid " + C.sepL, fontSize: 12, fontFamily: C.font, flex: 1 } },
                /* @__PURE__ */ React.createElement("option", null, "Small"),
                /* @__PURE__ */ React.createElement("option", { selected: true }, "Medium"),
                /* @__PURE__ */ React.createElement("option", null, "Large"))))),
          ...
          /* @__PURE__ */ React.createElement("div", { style: { padding: 12 } },
            ...
            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexWrap: "wrap", gap: 5, marginBottom: 8 } },
              [{ l: "Clear", c: "#e0f7ff" }, { l: "Pale Yellow", c: "#fffde7" }, { l: "Yellow", c: "#fff176" }, { l: "Dark Yellow", c: "#f9a825" }, { l: "Amber", c: "#ff8f00" }, { l: "Brown", c: "#795548" }, { l: "Red/Pink", c: C.red }].map((u) => /* @__PURE__ */ React.createElement("button", { key: u.l, onClick: () => {
                ...
                setDocs((p) => [...p, { id: "d" + Date.now(), resId: selRes, type: "Vitals", d: today, t: new Date().toLocaleTimeString([], { hour: "numeric", minute: "2-digit" }), user: user.name, by: user.id, text: "🧪 Urine — " + u.l + (note ? " | " + note : "") + " — " + fn }]);
            ...
            /* @__PURE__ */ React.createElement("input", { id: "urine-note", placeholder: "Notes (optional)...", style: { width: "100%", padding: "8px 10px", borderRadius: 8, border: "1px solid " + C.sepL, fontSize: 12, fontFamily: C.font, boxSizing: "border-box" } }))),
        ...
        /* @__PURE__ */ React.createElement(Card, { style: { marginTop: 8, marginBottom: 8, overflow: "hidden" } },
          ...
          /* @__PURE__ */ React.createElement("div", { style: { padding: 12, display: "flex", gap: 8, alignItems: "flex-end" } },
            /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } },
              ...
              /* @__PURE__ */ React.createElement("input", { id: "temp-val", type: "number", step: "0.1", placeholder: "98.6", style: { width: "100%", padding: 8, borderRadius: 8, border: "1px solid " + C.sepL, fontSize: 16, fontWeight: 700, fontFamily: C.font, textAlign: "center", boxSizing: "border-box" } })),
            /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } },
              /* @__PURE__ */ React.createElement("label", { style: { fontSize: 9, color: C.tx3, fontWeight: 600, display: "block", marginBottom: 3 } }, "METHOD"),
              /* @__PURE__ */ React.createElement("select", { id: "temp-method", style: { width: "100%", padding: "8px 6px", borderRadius: 8, border: "1px solid " + C.sepL, fontSize: 12, fontFamily: C.font, boxSizing: "border-box" } },
            ...
            /* @__PURE__ */ React.createElement(Btn, { color: C.pk, onClick: () => {
              ...
              const method = document.getElementById("temp-method")?.value || "Oral";
              if (!v || v < 90 || v > 110) { alert("Please enter a valid temperature (90–110°F)"); return; }
              const status = v >= 100.4 ? " ⚠️ FEVER" : v < 96 ? " ⚠️ LOW" : " ✓ Normal";
              setDocs((p) => [...p, { id: "d" + Date.now(), resId: selRes, type: "Vitals", d: today, t: new Date().toLocaleTimeString([], { hour: "numeric", minute: "2-digit" }), user: user.name, by: user.id, text: "🌡️ Temp: " + v + "°F (" + method + ")" + status + " — " + fn }]);
