...
"severity":"low/medium/high/critical"}` }] }) });
  ...
  const [memos, setMemos] = useState([
    ...
    ,
    { id: "memo-demo1", d: "2026-03-13", t: "8:00 AM", by: "sa1", text: "TRAINING MEMO \u2014 Training Demo Home\n\nWelcome to Team ISR! This is a training environment with demo clients.\n\nJane Demo \u2014 47yo female. Dx: Intellectual Disability, Anxiety, Hypothyroidism. Allergies: Amoxicillin, Peanuts (SEVERE). 4 medications. Anxiety management plan.\n\nMarcus Training \u2014 33yo male. Dx: Autism (Level 2), Epilepsy, GERD. Allergies: Phenytoin (SEVERE), Dairy. 5 medications including seizure rescue. Elopement risk.\n\nReview each profile, MAR, behavior plans, IPP, and appointments. Practice shift notes, behavior logging, and medication administration.\n\nOriginal: Welcome to Team ISR! Please review each resident's profile, medications, and behavior plans before your first shift. All staff must complete the shift walkthrough checklist at the start and end of each shift. Contact your manager with any questions.", acks: ["sa1"], urgent: true }
  ]);
