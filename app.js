...
const STAFF0 = [
  { id: "sa1", first: "System", last: "Admin", name: "Admin, System", role: "System Admin", pin: "0000", password: "@Lower123", email: "sch.kgh.kts@gmail.com", phone: "", on: true, homes: ["SCH", "KGH", "HE"] },
...
"severity":"low/medium/high/critical"}` }] }) });
  ...
  if (!user) return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: C.font, background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 20 } }, /* @__PURE__ */ React.createElement("style", null, "@keyframes su{from{transform:translateY(100%)}to{transform:translateY(0)}}@keyframes memoFlash{from{opacity:1}to{opacity:0.3}}@keyframes flash{0%,100%{opacity:1}50%{opacity:.3}}@keyframes pulse{0%,100%{transform:scale(1)}50%{transform:scale(1.05)}}@keyframes shimmer{0%{background-position:-200% 0}100%{background-position:200% 0}}@keyframes spin{0%{transform:rotate(0deg)}100%{transform:rotate(360deg)}}input:focus,select:focus,textarea:focus{outline:none;border-color:" + C.blue + "!important;box-shadow:0 0 0 3px rgba(0,122,255,.12)!important}*{box-sizing:border-box;-webkit-tap-highlight-color:transparent;-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}button{-webkit-appearance:none;touch-action:manipulation}::-webkit-scrollbar{width:0;display:none}"), /* @__PURE__ */ React.createElement("div", { style: { background: C.card, borderRadius: 24, padding: "30px 24px", width: "100%", maxWidth: 380, boxShadow: "0 20px 60px rgba(0,0,0,.3)" } }, /* @__PURE__ */ React.createElement("div", { style: { textAlign: "center", marginBottom: 20 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 60, height: 60, borderRadius: 16, background: "linear-gradient(135deg, #667eea, #764ba2)", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 12px", fontSize: 28, color: "#fff" } }, "\u{1F3E0}"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 22, fontWeight: 800, color: C.tx } }, "Team ISR"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 12, color: C.tx3 } }, "Individual Support Record")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", marginBottom: 16, borderRadius: 10, overflow: "hidden", border: "1.5px solid " + C.sepL } }, /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setLoginMode("staff");
    setPinErr("");
  }, style: { flex: 1, padding: "10px", border: "none", background: loginMode === "staff" || loginMode === "pickStaff" ? C.blue : "transparent", color: loginMode === "staff" || loginMode === "pickStaff" ? "#fff" : C.tx3, fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: C.font } }, "Staff"), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setLoginMode("admin");
    setPinErr("");
  }, style: { flex: 1, padding: "10px", border: "none", background: loginMode === "admin" ? C.pur : "transparent", color: loginMode === "admin" ? "#fff" : C.tx3, fontSize: 13, fontWeight: 600, cursor: "pointer", fontFamily: C.font } }, "Manager / Admin")), loginMode === "staff" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: 600, color: C.tx3, display: "block", marginBottom: 3 } }, "Password"), /* @__PURE__ */ React.createElement("input", { type: "password", value: loginPass, onChange: (e) => setLoginPass(e.target.value), placeholder: "Enter staff password", style: { width: "100%", padding: "12px 14px", borderRadius: 10, border: "1.5px solid " + C.sepL, fontSize: 15, fontFamily: C.font, boxSizing: "border-box" }, onKeyDown: (e) => {
    if (e.key === "Enter") document.getElementById("staff-login-btn")?.click();
  } })), pinErr && /* @__PURE__ */ React.createElement("div", { style: { color: C.red, fontSize: 12, textAlign: "center", marginBottom: 8 } }, pinErr), /* @__PURE__ */ React.createElement("button", { id: "staff-login-btn", onClick: () => {
    if (loginPass === "staff123") {
      setLoginMode("pickStaff");
      setPinErr("");
    } else {
      setPinErr("Invalid password");
    }
  }, style: { width: "100%", padding: "12px", borderRadius: 10, border: "none", background: C.blue, color: "#fff", fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: C.font } }, "Sign In")) : loginMode === "pickStaff" ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 13, fontWeight: 600, color: C.tx3, marginBottom: 8 } }, "Select your name:"), /* @__PURE__ */ React.createElement("div", { style: { maxHeight: 300, overflow: "auto" } }, staff.filter((s) => s.on && s.role === "Staff").map((s) => /* @__PURE__ */ React.createElement("button", { key: s.id, onClick: () => {
    setUser(s);
    setLoginPass("");
    setLoginMode("staff");
  }, style: { width: "100%", padding: "12px 14px", marginBottom: 4, borderRadius: 10, border: "1.5px solid " + C.sepL, background: C.card, fontSize: 14, fontWeight: 600, cursor: "pointer", fontFamily: C.font, textAlign: "left", display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { style: { width: 36, height: 36, borderRadius: 10, background: C.blue + "12", display: "flex", alignItems: "center", justifyContent: "center", color: C.blue, fontWeight: 700, fontSize: 14, flexShrink: 0 } }, (s.first || "")[0], (s.last || "")[0]), /* @__PURE__ */ React.createElement("div", null, s.first, " ", s.last)))), /* @__PURE__ */ React.createElement("button", { onClick: () => {
    setLoginMode("staff");
    setLoginPass("");
  }, style: { width: "100%", padding: "10px", marginTop: 8, borderRadius: 10, border: "1px solid " + C.sepL, background: "transparent", fontSize: 13, cursor: "pointer", fontFamily: C.font, color: C.tx3 } }, "Back")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: 600, color: C.tx3, display: "block", marginBottom: 3 } }, "Email"), /* @__PURE__ */ React.createElement("input", { type: "email", value: loginEmail, onChange: (e) => setLoginEmail(e.target.value), placeholder: "Enter your email", style: { width: "100%", padding: "12px 14px", borderRadius: 10, border: "1.5px solid " + C.sepL, fontSize: 15, fontFamily: C.font, boxSizing: "border-box" } })), /* @__PURE__ */ React.createElement("div", { style: { marginBottom: 10 } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 11, fontWeight: 600, color: C.tx3, display: "block", marginBottom: 3 } }, "Password"), /* @__PURE__ */ React.createElement("input", { type: "password", value: loginPass, onChange: (e) => setLoginPass(e.target.value), placeholder: "Enter your password", style: { width: "100%", padding: "12px 14px", borderRadius: 10, border: "1.5px solid " + C.sepL, fontSize: 15, fontFamily: C.font, boxSizing: "border-box" }, onKeyDown: (e) => {
    if (e.key === "Enter") document.getElementById("admin-login-btn")?.click();
  } })), pinErr && /* @__PURE__ */ React.createElement("div", { style: { color: C.red, fontSize: 12, textAlign: "center", marginBottom: 8 } }, pinErr), /* @__PURE__ */ React.createElement("button", { id: "admin-login-btn", onClick: () => {
    const found = staff.find((s) => s.email && s.email.toLowerCase() === loginEmail.toLowerCase() && s.password === loginPass && s.on && s.role !== "Staff");
    if (found) {
      setUser(found);
      setLoginEmail("");
      setLoginPass("");
      ...
      setPinErr("Invalid email or password");
    }
  }, style: { width: "100%", padding: "12px", borderRadius: 10, border: "none", background: C.pur, color: "#fff", fontSize: 15, fontWeight: 700, cursor: "pointer", fontFamily: C.font } }, "Sign In"), /* @__PURE__ */ React.createElement("button", { onClick: () => alert("Contact System Admin at sch.kgh.kts@gmail.com for password reset."), style: { width: "100%", padding: "8px", marginTop: 8, borderRadius: 10, border: "none", background: "transparent", fontSize: 12, cursor: "pointer", fontFamily: C.font, color: C.blue } }, "Forgot Password?"))));
  ...
  const renderModal = () => {
    ...
    if (modal === "addStaff") {
      ...
      }))), /* @__PURE__ */ React.createElement(Inp, { label: "Password *", value: nStaff.password || "", onChange: (v) => setNStaff((p) => ({ ...p, password: v })), ph: "Enter password" }), /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px 6px" } }, /* @__PURE__ */ React.createElement("label", { style: { fontSize: 12, color: C.tx3, fontWeight: 500, display: "block", marginBottom: 4 } }, "Homes *"), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } }, HOMES.map((h) => {
    ...
    if (modal === "editStaff" && editStaff) {
      ...
      return /* @__PURE__ */ React.createElement(Modal, { title: "Edit: " + (es.first || "") + " " + (es.last || ""), onClose: () => {
        ...
        setEditStaff((p) => ({ ...p, password: np }));
        alert("Password reset to: " + np);
