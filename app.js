  ...
  const ResDetail = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Hdr, { title: fn, left: /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: m.id, style: { padding: "10px 12px", borderBottom: i < arr.length - 1 ? "0.5px solid " + C.sepL : "none", background: tc ? tc.bgL : "transparent" } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8 } }, cm ? /* @__PURE__ */ React.createElement("div", { style: { display: "flex", flexDirection: "column", gap: 3 } }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 4, padding: "3px 8px", borderRadius: 6, background: C.grn + "12", border: "1.5px solid " + C.grn + "40" } }, /* @__PURE__ */ React.createElement("div", { style: { width: 10, height: 10, borderRadius: 5, background: C.grn } }), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, fontWeight: 700, color: C.grn } }, "Active")), /* @__PURE__ */ React.createElement("div", { onClick: () => {
        ...
        setViewMed(m.id);
        setModal("medD");
      } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 600 } }, m.name, " ", m.dose, " ", /* @__PURE__ */ React.createElement("span", { style: { fontSize: 10, fontWeight: 700, color: C.blue, background: C.blue + "10", padding: "1px 5px", borderRadius: 4 } }, "x", m.tabsPerDose || 1)), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: C.tx3 } }, m.route, " | ", m.freq), (() => { if (!m.startDate || !m.pillCount) return null; const start = new Date(m.startDate); const dosesPerDay = (m.times || []).length || 1; const tabsPerDay = (m.tabsPerDose || 1) * dosesPerDay; const daysSince = Math.floor((new Date() - start) / 86400000); const pillsUsed = daysSince * tabsPerDay; const pillsLeft = Math.max(0, (m.pillCount || 0) - pillsUsed); const daysLeft = tabsPerDay > 0 ? Math.floor(pillsLeft / tabsPerDay) : 0; const nextStart = new Date(start); nextStart.setDate(start.getDate() + Math.ceil((m.pillCount || 0) / tabsPerDay)); const isShortTerm = m.isShortTerm; return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6, flexWrap: "wrap", marginTop: 3 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, padding: "2px 6px", borderRadius: 4, background: pillsLeft <= 7 ? C.red + "15" : C.grn + "12", color: pillsLeft <= 7 ? C.red : C.grn, fontWeight: 700 } }, "💊 " + pillsLeft + " pills left"), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, padding: "2px 6px", borderRadius: 4, background: C.blue + "10", color: C.blue, fontWeight: 600 } }, "Start: " + m.startDate), isAM && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 9, padding: "2px 6px", borderRadius: 4, background: C.pur + "10", color: C.pur, fontWeight: 600 } }, "Next fill: " + nextStart.toLocaleDateString("en-US", { month: "short", day: "numeric" }))); })(), isAM && /* @__PURE__ */ React.createElement("button", { onClick: (e) => { e.stopPropagation(); setMedUpdateForm({ ...m, origDose: m.dose, origFreq: m.freq, origTimes: (m.times || []).join(", "), origTabsPerDose: m.tabsPerDose || 1 }); setMedUpdateTab("info"); setModal("medUpdate"); }, style: { display: "flex", alignItems: "center", gap: 4, padding: "4px 10px", borderRadius: 7, border: "1.5px solid " + C.blue + "50", background: C.blue + "10", color: C.blue, fontSize: 10, fontWeight: 700, cursor: "pointer", fontFamily: C.font, marginTop: 4 } }, "✏️ Edit"),
