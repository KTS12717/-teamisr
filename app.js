              ...
              const renderMemoGroup = (groupMemos, groupKey) => {
                ...
                return Object.entries(byType).map(([type, typeMemos]) => {
                  ...
                  return /* @__PURE__ */ React.createElement(Card, { key: groupKey + "-" + type, style: { marginBottom: 8, overflow: "hidden" } },
                    /* @__PURE__ */ React.createElement("div", { style: { padding: "8px 12px", background: tInfo.color + "08", borderBottom: "0.5px solid " + C.sepL, display: "flex", alignItems: "center", gap: 6 } },
                      ...
                      return /* @__PURE__ */ React.createElement("div", { key: m.id, style: { borderBottom: mi < typeMemos.length - 1 ? "0.5px solid " + C.sepL : "none" } },
                        ...
                        expandedMemo === m.id && /* @__PURE__ */ React.createElement("div", { style: { padding: "0 12px 12px", background: C.alt, borderTop: "0.5px solid " + C.sepL } },
                          ...
                          /* @__PURE__ */ React.createElement("div", { style: { marginTop: 12 } },
                            /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, fontWeight: 700, color: C.tx3, textTransform: "uppercase", marginBottom: 4 } }, "Acknowledgment Sheet Link"),
                            /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 6 } },
                              /* @__PURE__ */ React.createElement("input", { value: memoSheetUrls[sheetKey] || "", onChange: (e) => setMemoSheetUrls((p) => ({ ...p, [sheetKey]: e.target.value })), placeholder: "Paste Google Sheets URL...", style: { flex: 1, padding: "8px 10px", borderRadius: 8, border: "1px solid " + C.sepL, fontSize: 12, fontFamily: C.font, boxSizing: "border-box" } }),
                              memoSheetUrls[sheetKey] && /* @__PURE__ */ React.createElement("a", { href: memoSheetUrls[sheetKey], target: "_blank", rel: "noopener noreferrer", style: { padding: "8px 12px", borderRadius: 8, background: "#34a853", color: "#fff", fontSize: 12, fontWeight: 700, textDecoration: "none", whiteSpace: "nowrap" } }, "\u{1F4CA} Open")
                            )
                          )
                        )
                      );
