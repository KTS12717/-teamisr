...
"severity":"low/medium/high/critical"}` }] }) });
  ...
  const ResDetail = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Hdr, { title: fn, left: /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      setEditApt({ ...newApt });
      setModal("aptEdit");
    } }, "+ Add")), /* @__PURE__ */ React.createElement("button", { onClick: () => { const erRes = residents.find((r) => r.id === selRes); setErVisit(mkErVisit(erRes)); setModal("erVisit"); }, style: { width: "100%", marginBottom: 12, padding: "13px 14px", borderRadius: 12, border: "2px solid " + C.red + "50", background: "linear-gradient(135deg," + C.red + "10," + C.red + "04)", cursor: "pointer", fontFamily: C.font, display: "flex", alignItems: "center", gap: 10, textAlign: "left", boxSizing: "border-box" } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 26 } }, "\uD83D\uDEA8"), /* @__PURE__ */ React.createElement("div", { style: { flex: 1 } }, /* @__PURE__ */ React.createElement("div", { style: { fontSize: 14, fontWeight: 700, color: C.red } }, "ER / Urgent Care Visit"), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: C.tx3 } }, "Log visit \u2022 auto-populates incident report")), /* @__PURE__ */ React.createElement(Ic, { n: "chev", s: 16, c: C.red })), appointments.filter((a) => a && a.resId === selRes).sort((a, b) => b.date.localeCompare(a.date)).map((a, i) => {
