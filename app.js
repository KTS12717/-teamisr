...
"severity":"low/medium/high/critical"}` }] }) });
  ...
  const ResDetail = () => {
    ...
    })) : ""), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 11, color: C.tx2, marginTop: 2 } }, m.instr)), /* @__PURE__ */ React.createElement(Pill, { text: m.freq === "PRN" ? "PRN" : "Sched", cl: m.freq === "PRN" ? C.blue : C.grn })), /* @__PURE__ */ React.createElement("div", { style: { fontSize: 10, color: C.tx3, marginTop: 4, paddingLeft: 40 } }, m.doctor, " | Rx: ", m.rx, m.reason ? " | " + m.reason : ""),
