  ...
  const ResDetail = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Hdr, { title: fn, left: /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      ...isS ? [
        ...
        ...r.home === "CCS" && (cm || isA || isS) ? [{ l: "CCS Schedule", sub: (() => { const ds = ccsSchedules[selRes] || {}; const active = CCS_DAYS.filter((d) => ds[d] && ds[d].time && ds[d].time !== "Off"); return active.length + " days scheduled"; })(), e: "\uD83D\uDCC5", c: "#5856d6", v: "ccssched" }] : [],
        ...(cm || isA || isS) ? [{ l: "Assignments", sub: (() => { const todayDA = (dailyAssigns[today] || {}); const cnt = Object.values(todayDA).reduce((s, sh) => s + Object.values(sh).reduce((s2, sids) => s2 + sids.length, 0), 0); return cnt + " assigned today"; })(), e: "\uD83D\uDCC5", c: C.pur, v: "assign" }] : []
      ]
    ...
    })()), resSubTab === "assign" && (cm || isA || isS) && /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px" } }, (() => {
