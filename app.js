...
"severity":"low/medium/high/critical"}` }] }) });
  ...
  const ResDetail = () => {
    ...
    return /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement(Hdr, { title: fn, left: /* @__PURE__ */ React.createElement("button", { onClick: () => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", borderBottom: i < sk.steps.length - 1 ? "0.5px solid " + C.sepL : "none", background: i % 2 === 0 ? "transparent" : C.alt + "40" } },
        ...
        /* @__PURE__ */ React.createElement("select", { value: val, onChange: (e) => { e.stopPropagation(); setSkillPrompts((p) => ({ ...p, [key]: e.target.value })); }, onClick: (e) => e.stopPropagation(), style: { fontSize: 11, padding: "4px 6px", borderRadius: 8, border: "1.5px solid " + promptColor, fontFamily: C.font, background: promptColor + "10", color: promptColor, fontWeight: 600, cursor: "pointer", minWidth: 110 } },
          PROMPTS.map((pr) => /* @__PURE__ */ React.createElement("option", { key: pr, value: pr }, pr))
        )
      );
  ...
  const renderModal = () => {
    ...
    if (modal && modal.startsWith("sk_")) {
      ...
      if (!sk) return null;
      return /* @__PURE__ */ React.createElement(Modal, { title: sk.name, onClose: () => setModal(null) }, /* @__PURE__ */ React.createElement("div", { style: { padding: "0 14px", paddingTop: 6 } }, /* @__PURE__ */ React.createElement(Card, null, sk.steps.map((st, i) => {
        const key = sk.name + "_" + i;
        const val = skillPrompts[key] || "Independent";
        const promptColor = val === "Independent" ? C.grn : val === "Indirect Verbal" || val === "Verbal" ? C.blue : val === "Gesture" || val === "Visual" || val === "Positional" ? C.org : val === "Full Physical" || val === "Incomplete" ? C.red : C.tx3;
        return /* @__PURE__ */ React.createElement("div", { key: i, style: { display: "flex", alignItems: "center", gap: 8, padding: "10px 12px", borderBottom: i < sk.steps.length - 1 ? "0.5px solid " + C.sepL : "none" } },
          ...
          /* @__PURE__ */ React.createElement("select", { value: val, onChange: (e) => { e.stopPropagation(); setSkillPrompts((p) => ({ ...p, [key]: e.target.value })); }, onClick: (e) => e.stopPropagation(), style: { fontSize: 12, padding: "6px 8px", borderRadius: 8, border: "2px solid " + promptColor, fontFamily: C.font, background: promptColor + "10", color: promptColor, fontWeight: 700, cursor: "pointer", minWidth: 130 } },
            PROMPTS.map((pr) => /* @__PURE__ */ React.createElement("option", { key: pr, value: pr }, pr))
          )
        );
